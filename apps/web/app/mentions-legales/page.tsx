        ...
        <section className="py-20 md:py-24 bg-cri-parchment">
          <div className="container-cri max-w-4xl">
            ...
            <p className="text-cri-humus leading-relaxed">
              ...
              <br />
              Email : <a href="mailto:contact@cri.africa" className="text-cri-cacao hover:underline">contact@cri.africa</a>
            </p>
            ...
            <p className="text-cri-humus leading-relaxed">
              Voir notre <a href="/privacy" className="text-cri-cacao hover:underline">politique de confidentialité</a>.
            </p>
            ...
            <p className="text-cri-humus leading-relaxed">
              Pour toute question : <a href="mailto:contact@cri.africa" className="text-cri-cacao hover:underline">contact@cri.africa</a>
            </p>
          </div>
        </section>
      </main>
