  ...
  return (
    <main className="container-cri py-16 max-w-4xl">
      <div className="flex items-center gap-3 mb-6">
        <Scale className="h-10 w-10 text-cri-cacao" aria-hidden="true" />
      ...
      <p>
        <strong>Cocoa Ranch &amp; Industry</strong> (CRI)<br />
        Programme porté par AGRO-PME Fondation<br />
        Cameroun, Bassin du Mungo<br />
        Email : <a href="mailto:contact@cri.africa">contact@cri.africa</a>
      </p>

      <h2 className="mt-8">2. Hébergement</h2>
      <p>
        <strong>Vercel Inc.</strong> — CDN edge global<br />
      ...
      <p>
        ...
        site est la propriété exclusive de Cocoa Ranch &amp; Industry / AGRO-PME Fondation
        ou de leurs partenaires. Toute reproduction sans autorisation préalable est interdite.
      </p>
      ...
      <p>
        Les informations publiées sur ce site sont fournies à titre indicatif. Malgré le
        soin apporté à leur mise à jour, Cocoa Ranch &amp; Industry ne saurait être tenu
        responsable des erreurs, d&apos;une absence de disponibilité des informations ou de
