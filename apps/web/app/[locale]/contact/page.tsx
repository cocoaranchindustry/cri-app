 ...
 * Libellés du hero (badge/title/subtitle) localisés via
 * `useTranslations("pages.contact")`. Le reste de la page
 * (formulaire, sections) reste à migrer dans une passe dédiée.
 */
