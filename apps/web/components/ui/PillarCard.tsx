...
/**
 * PillarCard — Carte de pilier d'activité (Brandbook CRI v6)
 *
 * Variantes :
 ...
 *
 * Design :
 * - Photo illustrative via next/image (optimisation auto WebP/AVIF + LQIP)
 * - Badge numéro en haut à droite
 * - Icône d'activité en haut à gauche dans un cercle blanc
 * - Titre + description + liste de bullets (avec icône Check lucide)
...
export const PillarCard: React.FC<PillarCardProps> = ({
  ...
  return (
    ...
    >
      {/* Image de fond — via next/image pour optimisation WebP/AVIF + LQIP */}
      {image ? (
        <>
